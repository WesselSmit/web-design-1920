...
// Make the CC-div element draggable (taken from: https://www.w3schools.com/howto/howto_js_draggable.asp)
function dragElement(elmnt) {
	...
	function elementDrag(e) {
		captionsContainer.classList.add("fullSize")
	...
	function closeDragElement() {
		captionsContainer.classList.remove("fullSize")
